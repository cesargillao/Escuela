			...
			<div class="list">
				...
				<table>
					...
					<?php while ($grados = mysqli_fetch_array($grados_secciones)){ ?>
							<tr>
								<td><?php echo utf8_encode($grados['abrev_grado']) ?>°</td>
								<td><?php echo utf8_encode($grados['desc_seccion']) ?></td>
								<td><?php echo utf8_encode($grados['mencion']) ?></td>
								<td><?php echo utf8_encode($grados['cedula_prof']) ?></td>
							</tr>
					<?php } ?>
					</tbody>
				</table> 
